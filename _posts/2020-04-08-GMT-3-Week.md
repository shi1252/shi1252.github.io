...
Proof.<br>
$f(x, y) = (x + 2y, 3x + y), \quad u = (3, 2), \quad v = (-4, 1), \quad k \in \mathbb{R}$<br>
$u + v = (3 - 4, 2 + 1) = (-1, 3)$<br>
$f(u + v) = (-1 + 2 \cdot (3), 3 \cdot(-1) + 3) = (5, 0)$<br>
$\begin{align}
f(u) + f(v) & = (3 + 2 \cdot (2), 3 \cdot (3) + 2) + (-4 + 2 \cdot (1), 3 \cdot (-4) + 1) \\\
& = (7, 11) + (-2, -11) \\\
& = (5, 0)
\end{align}$<br>
$\therefore f(u + v) = f(u) + f(v)$<br>
$kf(u) = k \cdot (7, 11) = (7k, 11k)$<br>
$f(ku) = (3k + 2 \cdot (2k), 3 \cdot (3k) + 2k) = (7k, 11k)$<br>
$\therefore kf(u) = f(ku)$
