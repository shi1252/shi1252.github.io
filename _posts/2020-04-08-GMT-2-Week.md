...
## Span
Let there are vectors that have same number of arguments in the same field.<br>
...
Vector that has only one argument is 1 and others are 0 in a Vector Space.<br>
